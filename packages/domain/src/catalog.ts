...
export const PRODUCTS: Product[] = [
  ...
  { id: 'rain', name: '雨后', subtitle: '雨洗过的青绿色。', series: '原创外观', description: '一场雨过后，城市换了颜色。温柔的青绿，像窗边慢慢清晰的风景。', color: '#7eaaa7', price: 20, packSize: 10, unlimited: false },
  { id: 'night', name: '夜班', subtitle: '把夜色收进口袋。', series: '原创外观', description: '天色暗下来，有些时间才属于自己。把这一抹安静的紫，留给夜里的片刻。', color: '#8b89b5', price: 30, packSize: 10, unlimited: false },
  { id: 'zhonghua-hard', name: '中华（硬）', brand: '中华', subtitle: '红色硬盒 · 20 支 / 盒', series: '品牌参考', description: '参考中华硬盒的红金包装。公开图鉴标注为烤烟型，以下为包装基础信息。', manufacturer: '上海烟草集团有限责任公司', packaging: '硬盒', lengthMm: 84, image: '/assets/products/zhonghua-hard.jpg', sourceUrl: 'https://www.ciggies.app/sku/187', color: '#a73530', price: 60, packSize: 20, unlimited: false },
  { id: 'hehua-hard', name: '钻石（荷花）', brand: '钻石', subtitle: '荷花系列 · 20 支 / 盒', series: '品牌参考', description: '钻石品牌的荷花款，包装以绿色与荷花图案为主。公开图鉴标注为烤烟型。', manufacturer: '河北中烟工业有限责任公司', packaging: '硬盒', lengthMm: 84, image: '/assets/products/hehua-hard.jpg', sourceUrl: 'https://www.ciggies.app/sku/1968', color: '#557b48', price: 40, packSize: 20, unlimited: false },
  { id: 'yuxi-soft', name: '玉溪（软）', brand: '玉溪', subtitle: '红白软包 · 20 支 / 盒', series: '品牌参考', description: '参考玉溪软包的红白配色与菱形标识。公开图鉴标注为烤烟型。', manufacturer: '红塔烟草（集团）有限责任公司', packaging: '软包', lengthMm: 84, image: '/assets/products/yuxi-soft.png', sourceUrl: 'https://www.ciggies.app/sku/282', color: '#b04735', price: 30, packSize: 20, unlimited: false },
  { id: 'baisha-hard', name: '白沙（硬）', brand: '白沙', subtitle: '白色硬盒 · 20 支 / 盒', series: '品牌参考', description: '参考白沙硬盒的白底红字与古井双鹤图案。公开图鉴标注为烤烟型。', manufacturer: '湖南中烟工业有限责任公司', packaging: '硬盒', lengthMm: 84, image: '/assets/products/baisha-hard.png', sourceUrl: 'https://www.ciggies.app/sku/1', color: '#b15343', price: 20, packSize: 20, unlimited: false },
];
